...
public class PaintingArt extends Product {
    ...
    public PaintingArt(String id, String name, String tagline, String desc, File heroImage, List<File> otherImages, float price, CurrencyCode currency, String backgroundColor, float rating, int views, int stockLevel, int totalReviews, Category category, String artist) {
